...
export function testExpressAxiosInterceptor() {
  const res = http.get('http://localhost:3005/api', {
    tags: { service: 'express-axios-interceptor' },
  });
...
export function testFastifyAxiosInterceptor() {
  const res = http.get('http://localhost:3006/api', {
    tags: { service: 'fastify-axios-interceptor' },
  });
...
export function testFastifyUndiciInterceptor() {
  const res = http.get('http://localhost:3007/api', {
    tags: { service: 'fastify-undici-interceptor' },
  });
