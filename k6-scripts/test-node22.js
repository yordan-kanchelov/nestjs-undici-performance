...
export function testFastifyAxios() {
  const res = http.get('http://localhost:3012/api', {
    tags: { service: 'fastify-axios-node22' },
  });
...
export function testFastifyUndici() {
  const res = http.get('http://localhost:3013/api', {
    tags: { service: 'fastify-undici-node22' },
  });
...
export function handleSummary(data) {
  ...
  return {
    'results/node22-performance-comparison.csv': csv,
    'results/node22-performance-summary.json': JSON.stringify(summary, null, 2),
